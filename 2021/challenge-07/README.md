...
> _Visita: [Reto #07](https://2021.adventjs.dev/challenges/07)_
...
Vamos a crear una función `contains` que recibe dos parámetros: un objeto
que define el almacén y el producto que buscamos.
